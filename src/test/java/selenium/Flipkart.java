...
public class Flipkart {
    //mouse over to (electronics,fashions,home,appliances) & capture the elements that displayed.

    @BeforeAll
    public static void launchEdgeBrowser() throws InterruptedException {
